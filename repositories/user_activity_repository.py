...
class UserActivityRepository:
    ...
    @staticmethod
    def get_general_user_activity(query: dict) -> GeneralUserActivity | None:
        try:
    ...
    @staticmethod
    def add_general_user_activity(activity: dict) -> None:
        new_activity: GeneralUserActivity = GeneralUserActivity(**activity)
        new_activity.save()

    @staticmethod
    def update_general_user_activity(pk: str, changes: dict) -> None:
        GeneralUserActivity.objects(id=ObjectId(pk)).update_one(**changes)

    @staticmethod
    def get_state_user_activity(query: dict) -> StateUserActivity | None:
        try:
    ...
    @staticmethod
    def add_state_user_activity(activity: dict) -> None:
        new_activity: StateUserActivity = StateUserActivity(**activity)
        new_activity.save()

    @staticmethod
    def update_state_user_activity(pk: str, changes: dict) -> None:
        StateUserActivity.objects(id=ObjectId(pk)).update_one(**changes)

    @staticmethod
    def get_city_user_activity(query: dict) -> CityUserActivity | None:
        try:
    ...
    @staticmethod
    def add_city_user_activity(activity: dict) -> None:
        new_activity: CityUserActivity = CityUserActivity(**activity)
        new_activity.save()

    @staticmethod
    def update_city_user_activity(pk: str, changes: dict) -> None:
